<section id="cover" class="min-h-screen flex items-center justify-center relative overflow-hidden pt-16 pb-20">
    ...
    <div class="absolute inset-0 overflow-hidden">
        ...
        <img src="<?php echo e(asset('storage/' . $wedding->cover_image)); ?>" alt="Cover" class="w-full h-full object-cover">
    ...
    <div class="relative z-10 text-center px-6 max-w-md mx-auto section-fade">
        ...
        <p class="text-stone-600 text-sm sm:text-base font-medium">
            <?php echo e(\Carbon\Carbon::parse($wedding->event_date)->isoFormat('dddd, D MMMM YYYY')); ?>
...
<?php /**PATH C:\xampp\htdocs\hanvitation\resources\views/guest/partials/cover.blade.php ENDPATH**/ ?>