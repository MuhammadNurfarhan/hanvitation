<div x-show="showEnvelope"
    ...
    <button @click="toggleMusic()"
        ...
        <svg x-show="!isPlaying" class="w-5 h-5 text-amber-700" fill="currentColor" viewBox="0 0 20 20">
            <path d="M18 3a1 1 0 00-1.196-.98l-10 2A1 1 0 006 5v9.114A4.369 4.369 0 005 14c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V7.82l8-1.6v5.894A4.37 4.37 0 0115 12c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V3z"/>
        </svg>
        <svg x-show="isPlaying" class="w-5 h-5 text-amber-700" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute top-32 right-16 w-14 h-14 opacity-15 animate-pulse text-amber-300" style="animation-delay: 0.5s;">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" /></svg>
        </div>
        <div class="absolute bottom-40 left-20 w-10 h-10 opacity-10 animate-pulse text-red-200" style="animation-delay: 1s;">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" /></svg>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden ring-1 ring-stone-200/50">
            ...
            <div class="px-6 pb-8 pt-4 text-center relative -mt-2">
                ...
                <h2 class="font-serif-custom text-xl sm:text-2xl font-bold text-red-900 mt-2 leading-tight px-2">
                    <?php echo e($guestName ?: 'Tamu Undangan'); ?>
...
<?php /**PATH C:\xampp\htdocs\hanvitation\resources\views/guest/partials/envelope.blade.php ENDPATH**/ ?>