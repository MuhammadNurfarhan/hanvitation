<section id="gift" class="py-16 sm:py-20 px-6 bg-gradient-to-b from-stone-50 to-white section-fade">
    <div class="max-w-lg mx-auto">
        ...
        <div class="space-y-4">
            <?php $__currentLoopData = $wedding->bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl p-5 shadow-lg border border-stone-100">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="font-serif-custom text-lg font-bold text-stone-800"><?php echo e($bank->bank_name); ?></h3>
                </div>

                <div class="space-y-2 mb-4">
                    <div>
                        <p class="text-[10px] text-stone-400 uppercase tracking-wider">Nomor Rekening</p>
                        <p class="font-mono text-xl font-bold text-stone-800 tracking-wider"><?php echo e($bank->account_number); ?></p>
                    </div>
                    <div>
                        <p class="text-[10px] text-stone-400 uppercase tracking-wider">Atas Nama</p>
                        <p class="font-medium text-stone-700"><?php echo e($bank->account_holder); ?></p>
                    </div>
                </div>

                <button @click="copyToClipboard('<?php echo e($bank->account_number); ?>', '<?php echo e($bank->bank_name); ?>')"
        ...
        <div class="mt-8 text-center">
            ...
            <div class="inline-block bg-white p-4 rounded-2xl shadow-lg">
                <img src="<?php echo e(asset('storage/' . $wedding->qr_code)); ?>" alt="QR Code" class="w-40 h-40 object-contain">
            </div>
        </div>
        <?php endif; ?>
    </div>
</section>
<?php /**PATH C:\xampp\htdocs\hanvitation\resources\views/guest/partials/digital-envelope.blade.php ENDPATH**/ ?>