            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl">
                <div class="p-6 text-stone-900">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h3 class="text-xl font-serif font-bold">Selamat Datang, <?php echo e(Auth::user()->name); ?> 🕊️</h3>
                            <p class="text-stone-500 mt-1">Kelola undangan pernikahan digital Anda dari sini.</p>
                        </div>
                        <a href="<?php echo e(route('weddings.create')); ?>" class="inline-flex items-center px-4 py-2 bg-red-900 text-white rounded-xl hover:bg-red-800 transition shadow">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        ...
                        <a href="<?php echo e(route('weddings.index')); ?>" class="group bg-white p-6 rounded-2xl shadow-sm border border-stone-200 hover:border-red-300 hover:shadow-md transition-all duration-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm text-stone-500 uppercase tracking-wider font-medium">Wedding Management</p>
                                    <p class="text-3xl font-bold text-red-900 mt-2"><?php echo e($totalWeddings ?? 0); ?></p>
                        ...
                        <a href="<?php echo e(route('guests.index')); ?>" class="group bg-white p-6 rounded-2xl shadow-sm border border-stone-200 hover:border-amber-300 hover:shadow-md transition-all duration-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm text-stone-500 uppercase tracking-wider font-medium">Guest Management</p>
                                    <p class="text-3xl font-bold text-amber-700 mt-2"><?php echo e($totalGuests ?? 0); ?></p>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hanvitation\resources\views/dashboard.blade.php ENDPATH**/ ?>