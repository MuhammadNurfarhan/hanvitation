    ...
    <div class="max-w-lg mx-auto">
        ...
        <div class="rounded-2xl p-6 shadow-lg mb-6 border transition-all hover:shadow-xl
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div
                    class="w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg bg-{{ $event->type_color }}-700">
                    {!! $event->type_icon !!}
                </div>
            ...
            <div class="space-y-3 mb-5 ml-4">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="font-medium text-stone-800 text-sm mt-1">{{ $event->venue_name }}</p>
            ...
            {{-- Google Maps Button --}}
            @if($event->maps_link)
            <a href="{{ $event->maps_link }}" target="_blank" class="flex items-center justify-center gap-2 w-full py-3 rounded-xl font-medium transition-colors text-sm
               {{
