    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-2xl p-6">
                <form action="{{ route('weddings.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                {{-- Image Preview --}}
                                <img id="cover_preview" class="mt-4 w-full max-w-xs rounded-xl shadow hidden"
                                     src="#" alt="Preview" />
                            </div>
